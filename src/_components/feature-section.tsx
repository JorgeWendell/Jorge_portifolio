...
function FeatureSection() {
    return (
        <section id="feature" className="bg-slate-100 dark:bg-transparent container space-y-6 py-8 md:py-12 lg:py-24">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
                Tech Stack
            </h2>
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                A cada projeto um desafio novo, sempre usando as melhores Stacks do mercado!
            </p>
          </div>
          <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-x-[64rem] md:grid-cols-3">
        ...
        <div className='relative overflow-hidden rounded-lg border bg-background p-2'>
          <div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-sm text-muted-foreground'>
                ORM usando Prisma com SQLite e Postgres.
              </p>
            </div>
          </div>
        </div>
